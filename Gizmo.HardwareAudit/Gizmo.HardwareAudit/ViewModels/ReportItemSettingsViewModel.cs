...
namespace Gizmo.HardwareAudit.ViewModels
{
    public class ReportItemSettingsViewModel : BaseViewModel
    {
        ...
        public ReportItemSettingsViewModel()
        {
            ContainerDescription = string.Empty;
            ContainerName = string.Empty;
        }
        public ReportItemSettingsViewModel(string name, string description)
        {
            ContainerDescription = description;
            ContainerName = name;
        }
        public ReportItemSettingsViewModel(string name, string description, bool useCustomIcon, GizmoIconEnum customIcon)
        {
            ContainerDescription = description;
            ContainerName = name;
